    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('series', models.CharField(blank=True, help_text='Passport series', max_length=5, null=True)),
                ('number', models.CharField(blank=True, help_text='Passport number', max_length=10, null=True)),
                ...
                ('neighborhood', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='utils.neighborhood')),
            ...
            options={
                ...
                'db_table': 'user',
                'indexes': [models.Index(fields=['username'], name='user_usernam_b79065_idx'), models.Index(fields=['phone_number'], name='user_phone_n_2e859d_idx')],
            },
            managers=[
